...
import {
    ...
    ASSISTANT_WITH_FUNC_CALL_AND_CONTENT, EXTRA_PROPERTY,
    FUNCTION_MISSING_CONTENT,
    FUNCTION_MISSING_NAME,
    FUNCTION_MISSING_NAME_AND_CONTENT,
    MESSAGE_PROPERTY_EMPTY,
    MESSAGES_WITH_EMPTY_FUNC_LIST, MESSAGES_WITH_FUNC_ITEM_WITH_NAME_DESCRIPTION_ONLY,
